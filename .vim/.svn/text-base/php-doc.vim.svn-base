...
let g:pdv_cfg_Package = "Swim"
let g:pdv_cfg_Version = "v2"
let g:pdv_cfg_Author = "Luke Marsden <luke@simpleweb.co.uk>"
let g:pdv_cfg_Copyright = "2009 Simpleweb Ltd."
let g:pdv_cfg_License = "Commercial - All rights reserved"
